    ...
    methods: {
       ...
       //获取客户列表
        async getCustomerList() {
            ...
            this.finished = false
                let result = null
                const url=['getGroupDetail','getStaffDetail','getChannelDetail']
                if(this.$route.query.activeTab==='1'||this.$route.query.activeTab==='2'){
                   delete params.groupId
                }
                delete params.activeTab
                result = await API[url[this.$route.query.activeTab]](params)
